...
- (void)select:(UIButton *)selectButton {
    ...
    if (_selectedPhotoArr.count == 0) {
        [_okButton setTitleColor:[UIColor colorWithRed:(83/255.0) green:(179/255.0) blue:(17/255.0) alpha:0.5] forState:UIControlStateDisabled];
...
- (void)okButtonClick {
    NSLog(@"selct:%d",_selectedPhotoArr.count);
    if (_selectedPhotoArr.count == 0) {
        TZAssetModel *model = _photoArr[_currentIndex];
